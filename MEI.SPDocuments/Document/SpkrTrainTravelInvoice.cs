...
{
    [DocumentInfo(SPDocumentType.SpkrTrainTravelInvoice, "SpkrTrainTravelInvoice", "STTINV")]
    public class SpkrTrainTravelInvoice
        : SPDocumentBase, ISearchProgram, ISearchSpeaker, ISearchYear
    {
        internal SpkrTrainTravelInvoice(IRepository repository, IDbUtilities dbUtilities, DocumentTypeInfo documentTypeInfo)
            : base(repository, dbUtilities, documentTypeInfo)
        { }

        public SpkrTrainTravelInvoice WithValues(string programId, int? speakerCounter)
        {
            ProgramId = programId;
