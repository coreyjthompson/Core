...
{
    [DocumentInfo(SPDocumentType.SpkrTrainTravelItinerary, "SpkrTrainTravelItinerary", "STTI")]
    public class SpkrTrainTravelItinerary
        : SPDocumentBase, ISearchProgram, ISearchSpeaker, ISearchYear
    {
        internal SpkrTrainTravelItinerary(IRepository repository, IDbUtilities dbUtilities, DocumentTypeInfo documentTypeInfo)
            : base(repository, dbUtilities, documentTypeInfo)
        { }

        public SpkrTrainTravelItinerary WithValues(string programId, int? speakerCounter)
        {
            ProgramId = programId;
