...
{
    [DocumentInfo(SPDocumentType.CheckRequest, "CheckRequest", "CR", "CheckRequest", "Check Request")]
    public class CheckRequest
        : SPDocumentBase, ISearchExpense, ISearchSpeaker, ISearchProgram, ISearchYear
    {
        internal CheckRequest(IRepository repository, IDbUtilities dbUtilities, DocumentTypeInfo documentTypeInfo)
            : base(repository, dbUtilities, documentTypeInfo)
        { }

        public CheckRequest WithValues(string programId, int? speakerCounter, int? expenseCounter)
        {
