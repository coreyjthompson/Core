...
{
    [DocumentInfo(SPDocumentType.ADCV, "ADCV")]
    public class ADCV
        : SPDocumentBase, ISearchTrackNumber
    {
        internal ADCV(IRepository repository, IDbUtilities dbUtilities, DocumentTypeInfo documentTypeInfo)
            : base(repository, dbUtilities, documentTypeInfo)
        { }

        public ADCV WithValues(int? trackNumber, string hcpFirstName, string hcpLastName)
        {
