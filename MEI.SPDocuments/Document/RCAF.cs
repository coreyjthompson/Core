...
{
    [DocumentInfo(SPDocumentType.RequestforConsultantApprovalForm, "RequestforConsultantApprovalForm", "RCAF")]
    public class RequestforConsultantApprovalForm
        : SPDocumentBase, ISearchProgram, ISearchYear
    {
        internal RequestforConsultantApprovalForm(IRepository repository, IDbUtilities dbUtilities, DocumentTypeInfo documentTypeInfo)
            : base(repository, dbUtilities, documentTypeInfo)
        { }

        public RequestforConsultantApprovalForm WithValues(string programId)
        {
            ProgramId = programId;
