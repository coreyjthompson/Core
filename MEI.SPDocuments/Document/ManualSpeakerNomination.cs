...
{
    [DocumentInfo(SPDocumentType.ManualSpeakerNomination, "ManualSpeakerNomination", "MSN", "ManualSpeakerNomination")]
    public class ManualSpeakerNomination
        : SPDocumentBase, ISearchSpeaker, ISearchYear
    {
        internal ManualSpeakerNomination(IRepository repository, IDbUtilities dbUtilities, DocumentTypeInfo documentTypeInfo)
            : base(repository, dbUtilities, documentTypeInfo)
        { }

        public ManualSpeakerNomination WithValues(int? speakerNominationId, int? speakerCounter, DocumentYear documentYear)
        {
        ...
        public override string ParsableFileName => MakeFileName(SpeakerNominationId, SpeakerCounter, DocumentYear.ToDisplayNameLong());
        ...
        public override string UniqueValues => string.Format("{0};{1}", SpeakerNominationId, DocumentYear.ToDisplayNameLong());
