...
{
    [DocumentInfo(SPDocumentType.PID, "PWImportDoc", "PID")]
    public class PWImportDoc
        : SPDocumentBase
    {
        private DateTime _dateTime;

        internal PWImportDoc(IRepository repository, IDbUtilities dbUtilities, DocumentTypeInfo documentTypeInfo)
            : base(repository, dbUtilities, documentTypeInfo)
        { }

        public PWImportDoc WithValues(DateTime dateTime)
        {
            _dateTime = dateTime;
