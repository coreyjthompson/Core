...
{
    [DocumentInfo(SPDocumentType.SpeakerNomInitiationDateExcpt,
        "SpeakerNomInitiationDateExcpt",
        "SNIDE",
        "SpeakerNomInitiationDateExcpt",
        "Speaker Nom Initiation Date Excpt")]
    public class SpeakerNomInitiationDateExcpt
        : SPDocumentBase, ISearchSpeaker, ISearchYear
    {
        internal SpeakerNomInitiationDateExcpt(IRepository repository, IDbUtilities dbUtilities, DocumentTypeInfo documentTypeInfo)
            : base(repository, dbUtilities, documentTypeInfo)
        { }

        public SpeakerNomInitiationDateExcpt WithValues(int? speakerNominationId, int? speakerCounter, DocumentYear documentYear)
        {
        ...
        [SPFieldInfo(SPFieldNames.SpeakerCounter, "Spkrcounter", SPFieldType.Text, 2)]
        ...
        public override string ParsableFileName =>
            MakeFileName(SpeakerNominationId.ToString(), SpeakerCounter.ToString(), DocumentYear.ToDisplayNameLong());
