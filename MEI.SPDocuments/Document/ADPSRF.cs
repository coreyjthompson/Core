...
{
    [DocumentInfo(SPDocumentType.ADPSRF, "ADPSRF")]
    public class ADPSRF
        : SPDocumentBase, ISearchTrackNumber
    {
        internal ADPSRF(IRepository repository, IDbUtilities dbUtilities, DocumentTypeInfo documentTypeInfo)
            : base(repository, dbUtilities, documentTypeInfo)
        { }

        public ADPSRF WithValues(int? trackNumber, string hcpFirstName, string hcpLastName)
        {
