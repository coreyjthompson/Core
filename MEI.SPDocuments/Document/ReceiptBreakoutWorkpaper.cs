...
{
    [DocumentInfo(SPDocumentType.ReceiptBreakoutWorkpaper, "ReceiptBreakoutWorkpaper", "RBW", "RBW", "RBW", "RBW")]
    public class ReceiptBreakoutWorkpaper
        : SPDocumentBase, ISearchExpense, ISearchProgram, ISearchVendor, ISearchYear
    {
        internal ReceiptBreakoutWorkpaper(IRepository repository, IDbUtilities dbUtilities, DocumentTypeInfo documentTypeInfo)
            : base(repository, dbUtilities, documentTypeInfo)
        { }

        public ReceiptBreakoutWorkpaper WithValues(string programId, int? expenseCounter)
        {
        ...
        [SPFieldInfo(SPFieldNames.ExpenseCounter, "ExpenseCounter", SPFieldType.Text, "ExpenseCounter", 1)]
