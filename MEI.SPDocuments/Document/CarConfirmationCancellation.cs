...
namespace MEI.SPDocuments.Document
{
    ...
    [DocumentInfo(SPDocumentType.CarConfirmationCancellation,
        "CarConfirmationCancellation",
        "CCC",
        "CCC",
        "Car Confirmation Cancellation")]
    public class CarConfirmationCancellation
        : SPDocumentBase, ISearchSpeaker, ISearchProgram, ISearchYear
    {
        internal CarConfirmationCancellation(IRepository repository, IDbUtilities dbUtilities, DocumentTypeInfo documentTypeInfo)
            : base(repository, dbUtilities, documentTypeInfo)
        { }

        public CarConfirmationCancellation WithValues(string programId, int? speakerCounter, int? spSeriesId)
        {
            ProgramId = programId;
