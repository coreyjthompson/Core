...
{
    [DocumentInfo(SPDocumentType.PPPE, "ProgramPolicyProcedureException", "PPPE", "PPPE", "PPPE")]
    public class ProgramPolicyProcedureException
        : SPDocumentBase, ISearchSpeaker, ISearchProgram, ISearchYear
    {
        internal ProgramPolicyProcedureException(IRepository repository, IDbUtilities dbUtilities, DocumentTypeInfo documentTypeInfo)
            : base(repository, dbUtilities, documentTypeInfo)
        { }

        public ProgramPolicyProcedureException WithValues(string programId, int? speakerCounter)
        {
            ProgramId = programId;
