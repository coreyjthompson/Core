...
{
    [DocumentInfo(SPDocumentType.RE, "ReinstatementException", "RE", "RE", "ReinstatementException", "ReinstatementException")]
    public class ReinstatementException
        : SPDocumentBase, ISearchProgram, ISearchYear
    {
        internal ReinstatementException(IRepository repository, IDbUtilities dbUtilities, DocumentTypeInfo documentTypeInfo)
            : base(repository, dbUtilities, documentTypeInfo)
        { }

        public ReinstatementException WithValues(string programId)
        {
            ProgramId = programId;
