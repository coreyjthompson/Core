...
{
    [DocumentInfo(SPDocumentType.AirlineTicket, "AirlineTicket", "AT", "AT", "Airline Ticket")]
    public class AirlineTicket
        : SPDocumentBase, ISearchSpeaker, ISearchProgram, ISearchYear
    {
        internal AirlineTicket(IRepository repository, IDbUtilities dbUtilities, DocumentTypeInfo documentTypeInfo)
            : base(repository, dbUtilities, documentTypeInfo)
        { }

        public AirlineTicket WithValues(string programId, int? speakerCounter, int? spSeriesId)
        {
            ProgramId = programId;
