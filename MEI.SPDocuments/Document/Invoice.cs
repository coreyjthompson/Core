...
{
    [DocumentInfo(SPDocumentType.Invoice, "Invoice", "INV", "Invoice")]
    public class Invoice
        : SPDocumentBase, ISearchExpense, ISearchProgram, ISearchYear
    {
        internal Invoice(IRepository repository, IDbUtilities dbUtilities, DocumentTypeInfo documentTypeInfo)
            : base(repository, dbUtilities, documentTypeInfo)
        { }

        public Invoice WithValues(string programId, int? expenseCounter)
        {
