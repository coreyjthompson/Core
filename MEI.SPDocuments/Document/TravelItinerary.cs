...
namespace MEI.SPDocuments.Document
{
    ...
    [DocumentInfo(SPDocumentType.TravelItinerary, "TravelItinerary", "TI")]
    public class TravelItinerary
        : SPDocumentBase, ISearchProgram, ISearchYear
    {
        internal TravelItinerary(IRepository repository, IDbUtilities dbUtilities, DocumentTypeInfo documentTypeInfo)
            : base(repository, dbUtilities, documentTypeInfo)
        { }

        public TravelItinerary WithValues(string programId, int travelDocId, int tramsHistoryId)
        {
            ProgramId = programId;
        ...
        [SPFieldInfo(SPFieldNames.TramsHistoryId, "TramsHistoryId", SPFieldType.Text, 10)]
        public int TramsHistoryId { get; private set; }

        [SPFieldInfo(SPFieldNames.RecordLocator, "RecordLocator", SPFieldType.Text, 11)]
            ...
            return new Dictionary<string, string>
                   {
                       ...
                       { SPFields[SPFieldNames.RecordLocator].InternalName, RecordLocator }
                   };
        }
        ...
        public override string[] ParseFileName(string fileNameToParse)
        {
            ...
            //' Lookup record locator from TravelDocSearch table
            RecordLocator = Repository.GetRecordLocatorForTravelDocId(TravelDocId);
