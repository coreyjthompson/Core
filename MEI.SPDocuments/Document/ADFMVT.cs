...
{
    [DocumentInfo(SPDocumentType.ADFMVT, "ADFMVT")]
    public class ADFMVT
        : SPDocumentBase, ISearchTrackNumber
    {
        internal ADFMVT(IRepository repository, IDbUtilities dbUtilities, DocumentTypeInfo documentTypeInfo)
            : base(repository, dbUtilities, documentTypeInfo)
        { }

        public ADFMVT WithValues(int? trackNumber, string hcpFirstName, string hcpLastName)
        {
            ...
            return new Dictionary<string, string>
                   {
                       ...
                       { SPFields[SPFieldNames.HcpFirstName].InternalName, HcpFirstName },
        ...
        public override string[] ParseFileName(string fileNameToParse)
        {
            ...
            if (!int.TryParse(fileNameParts[1], out int tempTrackNumber))
            {
